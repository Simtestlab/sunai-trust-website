        ...
        <div className="max-w-4xl">
          <div className="animate-fade-up">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight mb-6">
              ...
              <span className="block text-accent">Hope.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <a
                href="/about-us"
                className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-accent text-accent-foreground font-semibold text-lg hover:bg-accent/90 transition-colors"
              >
                About SUNAI
              </a>
              <a
                href="/volunteer"
                className="inline-flex items-center justify-center px-8 py-3 rounded-full border-2 border-white text-white font-semibold text-lg hover:bg-white/10 transition-colors"
              >
                Be the Change
              </a>
            </div>
